										...
										<div style="border:1px solid lightgrey;padding-top:10px;padding-bottom:10px;margin-top:10px;">
											...
											<div class="row">
												...
												<div class="col-sm-12 m_top10">
													<button type ="button" class="btn btn-lg btn-success pull-right displayCls" id="advanceSearchId" reportType="" attr_document="search" style="cursor: pointer; font-weight: bold; border-radius: 0px;">SEARCH</button>
													<!--
													<button type ="button" class=" btn btn-lg btn-success displayCls" id="advanceExcelId" attr_document="excel" style="cursor: pointer; font-weight: bold; border-radius: 0px;">EXCEL</button>
													-->
												</div>
