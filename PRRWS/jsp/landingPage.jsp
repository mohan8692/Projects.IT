			...
			<div class="row" style="color:white;">
				<div class="mainBlockUl">
					<ul class="blocksLi">
						...
						<!--<li style="display:table-cell;max-width:200px;padding-left: 10px;margin-right: 10px;min-width:150px;text-align:center">
							<div class="block" landing-link="review" id="reviewMenu" attr_blockId="7">
								<div style="display:inline-block;height:83px;width:50px;">
									<img src="Assests/img/Path 233.png" alt="Review" style="display:block;margin:auto">
								</div>
								<div style="display:inline-block;height:83px;width:50px;">
									<img src="Assests/img/Path 233.png" alt="Review" style="display:block;margin:auto">
								</div>
								<h5 style="margin-top:-15px">REVIEW</h5>
							</div>
						</li>-->
						<li style="width:180px;">
						...
						<li style="width:180px;">
							<div class="block" landing-link="prenc" id="prencMenu" attr_blockId="3">
								<div style="height:70px;width:100%;margin:auto;">
									<img src="Assests/img/Roads_Buildings.png" alt="PR ENC" style="display:block;margin:auto">
								</div>
								<h5>PR ENC</h5>
							</div>
						</li>
						...
						<li style="width:180px;">
							<div class="block" landing-link="swachhbharat" id="swachhbharatMenu" attr_blockId="6">
								<div style="height:70px;width:100%;margin:auto;">
									<img src="Assests/img/swachh_bharat_1.png" alt="SWACHH BHARAT" style="display:block;margin:auto">
								</div>
								<h5>SWACHH BHARAT</h5>
							</div>
						</li>
				...
				<div class="col-sm-2 text-center">
					<div class="block" landing-link="review" id="reviewMenu" attr_blockId="7">
						<div style="height:70px;width:100%;margin:auto;">
							<img src="Assests/img/Group 2353.png" alt="Review" style="display:block;margin:auto">
						</div>
						<h5>REVIEW</h5>
					</div>
				</div>
