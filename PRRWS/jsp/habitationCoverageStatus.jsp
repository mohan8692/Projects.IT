...
<script src="Assests/habitationCoverageStatus/habitationCoverageStatusDashboard.js" type="text/javascript"></script><script src="Assests/Menu/menu.js" type="text/javascript"></script>                
</body>
</html>