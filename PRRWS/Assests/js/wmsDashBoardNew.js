...
function getWorkTypeWiseCompletedDetails(){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkTypeWiseCompletedDetailsNew',
		dataType: 'json',
...
function buildWorkTypeWiseCompletedDetails(result){
	...
	for(var i in result){
		...
		if(result[i].govtMainWorkId !=1 && result[i].govtMainWorkId !=3){
			k=k+1;
	...
	timeLineAndLocationWiseDetails(result[1].govtMainWorkId);
	stateLevelWiseDetails(result[1].govtMainWorkId);
	locationWiseDetails(result[1].govtMainWorkId);
...
function getSubDivisionsOfDivision(divisonId,divId,LevelVal){
	...
	$.ajax({                
		type:'POST',    
		url: 'getSubDivisionsOfDivisionNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getTehsilsOfSubDivision(subDivisonId,divId,LevelVal){
	...
	$.ajax({                
		type:'POST',    
		url: 'getTehsilsOfSubDivisionNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getAllStatusOfWorkType(workTypeId,divId,locationValue,workZoneId){
	...
	$.ajax({                
		...
		if(result !=null && result.length>0){
			buildworkStagesDetails(result,workTypeId,divId,locationValue,workZoneId);
		}else{
...
function buildworkStagesDetails(result,workTypeId,divId,locationValue,workZoneId){
	var str='';
	...
	if(result !=null && result.length>0){
			if(divId == "workStagesDivId"){
				...
				str+='<ul class="list-inline locationWiseworkStagesCls">';
						str+='<li style="border:2px solid #000" attr_work_statusid ="0" attr_value="ALL" attr_locationLevelId="'+locationValue+'" attr_work_id="'+workTypeId+'"><h5 style="background-color:#000">All</h5></li>';
						for(var i in result){
							str+='<li  attr_work_statusid="'+result[i].key+'" attr_locationLevelId="'+locationValue+'" attr_value="'+result[i].value+'" attr_work_id="'+workTypeId+'"><h5 style="background-color:'+globalStatusObj[result[i].value]+'">'+result[i].value+'</h5></li>';
						}
					str+='</ul>';
				str+='</div>';
				...
				str+='<ul class="list-inline workZoneworkStagesCls">';
						str+='<li style="border:2px solid #000" attr_work_statusid ="0" attr_value="ALL" attr_workZone_id="'+workZoneId+'" attr_work_id="'+workTypeId+'"><h5 style="background-color:#000">All</h5></li>';
						for(var i in result){
							str+='<li  attr_work_statusid="'+result[i].key+'" attr_value="'+result[i].value+'" attr_workZone_id="'+workZoneId+'" attr_work_id="'+workTypeId+'"><h5 style="background-color:'+globalStatusObj[result[i].value]+'" attr_locationLevelId="'+locationValue+'">'+result[i].value+'</h5></li>';
						}
					str+='</ul>';
				str+='</div>';
				str+='<hr class="m_bottom_0" style="border-top: 1px solid #777 !important;margin-top: 10px;"/>';
...
function getLocationStatusDayWiseKms(statusId,workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationStatusDayWiseKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getLocationLevelStatusDayWiseKms(statusId,workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationLevelStatusDayWiseKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
	...
	str+='<div class="table-responsive">';
		str+='<table class="table table-bordered table_custom_WMS">';
			...
			str+='<tbody>';
				for(var i in result){
					str+='<tr>';
						str+='<td style="text-align:left !important;"><h5><i class="fa fa-plus plus_icon_WMS openNextTrShowCls active" aria-hidden="true" attr_tr_id="'+i+'" attr_kms="'+result[i].kms+'" attr_tr_name="'+result[i].documentName.replace(/([`~!@#$%^&*()_|+\-=?;:'",.<>\{\}\[\]\\\/ ])+/g, '')+'" attr_locationScopeId="'+locationLevelId+'" attr_locationLevelId="'+result[i].documentId+'" attr_work_id="'+workTypeId+'"></i> '+result[i].documentName+'</h5></td>';
...
$(document).on("click",".openNextTrShowCls",function(){
	...
	if($(this).hasClass('active')){
		...
		getLocationLevelSubDayWiseKms(locationScopeId,locationLevelId,tr_id,workTypeId,kms)
	}else{
...
function getLocationLevelSubDayWiseKms(locationScopeId,locationLevelId,tr_id,workTypeId,kms){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationLevelSubDayWiseKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
$(document).on("click",".openNextTrShowCls12",function(){
	...
	if($(this).hasClass('active')){
		var kms = $(this).attr("attr_kms");
		getStatusWiseMainInfo(mainWorkId,kms,workTypeId);
		$(this).removeClass('fa fa-plus').addClass('fa fa-minus');
		$(this).removeClass('plus_icon_WMS').addClass('minus_icon_WMS');
		$(this).removeClass('active');
	}else{
...
function getStatusWiseMainInfo(mainWorkId,kms,workTypeId){
...
function getStateLevelOverAllDetails(workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getStateLevelOverAllDetailsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function buildStateLevelOverAllDetails(result){
	...
	var str='';
	var completePerc = 0;
	if(result.totalKms != 0)
		completePerc=(((result.completedKms*100)/result.totalKms)).toFixed(2);
	str+='<div class="col-sm-4">';
		str+='<div class="bg_yash_color_10 m_top10">';
				str+='<div class="row">';
					str+='<div class="col-sm-4">';
...
function getStatusWiseWorksAndKms(workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getStatusWiseWorksAndKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
	...
	str+='<div class="pad_10 m_top10">';
		...
		var k=0;
			for(var i in result){
				k=k+1;
				str+='<div class="col-sm-2">';
					str+='<img class="imageClickCls" attr_statusId="'+result[i].statusId+'"  attr_statusName="'+result[i].status+'" src="Assests/images/'+result[i].status+'.png" style="width: 100%;height: 100px;"/>';
					...
					str+='<div class="row">';
						str+='<div class="col-sm-12 m_top5">';
							str+='<div class="bg_StatusWorkCss">';
								...
								str+='<input class="m_top10" id="statusBar'+i+'" data-slider-id="statusBar'+i+'Slider" type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="'+result[i].completedPercentage.toFixed(0)+'" data-slider-tooltip="hide"/><span class="font_weight pull-right"></span>';
								...
								str+='<input class="m_top10" id="statusBarWorks'+i+'" data-slider-id="statusBarWorks'+i+'Slider" type="text" data-slider-min="0" data-slider-max="100" data-slider-step="1" data-slider-value="'+result[i].completedKmsPercentage.toFixed(0)+'" data-slider-tooltip="hide"/><span class="font_weight pull-right"></span>';
...
function getLocationWiseOverview(workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationWiseOverviewNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
			...
			buttons: [
				{
					...
					titleAttr	: 'CSV',
					title		:  "WMS UGD DashBoard",
					filename	:  'WMS UGD DashBoard_'+moment().format("DD/MMMM/YYYY  HH:MM"),
				},
				{
					extend		:'pdfHtml5',
...
$(document).on("click",".locationWisePopupCls",function(){
	...
	getMainWorksTimeLineWiseInfo(workId,locationValue);
	...
	getLocationRelatedWorkDocuments(locationValue)
});	
function getLocationLevelWiseOverviewDetails(workId,locationValue){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationLevelWiseOverviewDetailsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function buildLocationLevelWiseOverviewDetails(result){
		...
		str+='<div class="bg_yash_color_10 m_top10 text-center">';
			str+='<div class="row">';
				str+='<div class="col-sm-6">';
					str+='<h2 class="font_BebasNeue" style="color:#0080FF">'+result.mainWorksCount+'</h2>';
	...
	str+='<div class="col-sm-2">';
		str+='<div class="bg_yash_color_10 m_top10 text-center">';
			str+='<h2 class="font_BebasNeue" style="color:#009A33">'+result.completedKms.toFixed(2)+' KM</h2>';
			str+='<h4 class="font_BebasNeue m_top5 text-capital">COMPLETED KM</h4>';
		str+='</div>';
	str+='</div>';
	str+='<div class="col-sm-2">';
...
function getLocationLevelStatusWiseOverviewDetails(workId,locationValue){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationLevelStatusWiseOverviewDetailsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getWorkZoneStatusWiseKms(mainWorkId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkZoneStatusWiseKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getLocationOverviewStatusDayWiseKms(workId,statusId,locationValue){
	...
	$.ajax({                
		type:'POST',    
		url: 'getLocationOverviewStatusDayWiseKmsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getWorkZoneMainOverview(workZoneId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkZoneMainOverviewNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getWorkZoneStatusDetailsInfo(workZoneId,workTypeId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkZoneStatusDetailsInfoNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getWorkZoneDocumentDetailsInfo(workZoneId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkZoneDocumentDetailsInfoNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getWorkZoneWorkStategsDetailsInfo(workZoneId,statusId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getWorkZoneWorkStategsDetailsInfoNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
$(document).on("click",".imageClickCls",function(){
	...
	getStatusDistrictWiseCount(statusId,2,1);
	
});
function getStatusDistrictWiseCount(statusId,locationScopeId,locationValue){
	...
	$.ajax({
		type:'POST', 
		url: 'getStatusLocationWiseDocumentsCountNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
		...
		if(result !=null && result.length>0){
			buildStatusDistrictWiseDetails(result,statusId);
		}else{
			$("#ugdMonitoringlocationDivId").html("No Data Available");
		}
	});
}
function buildStatusDistrictWiseDetails(result,statusId){
...
$(document).on("click",".constituencyPopups",function(){
	...
	var locationValue = $(this).attr("attr_locationLevelId");
	var locationScopeId = $(this).attr("attr_locationScopeId");
	getStatusDivisionWiseWiseCount(statusId,locationScopeId,locationValue,locationScopeId);
	
});

function getStatusDivisionWiseWiseCount(statusId,locationScopeId,locationValue,locationScopeId){
	...
	$.ajax({
		...
		if(result !=null && result.length>0){
			buildStatusDivisionWiseDetails(result,statusId,locationValue,locationScopeId);
		}else{
			$("#divisionBlock"+locationValue).html("No Data Available");
		}
	});
}
function buildStatusDivisionWiseDetails(result,statusId,locationValue,locationScopeId){
	getStatusDistrictDayWiseDocuments(statusId,result[0].districtId,result[0].documentId);
	var str='';
...
$(document).on("click",".divisionPopups",function(){
	...
	var locationValue = $(this).attr("attr_locationLevelId");
	var locationScopeId = $(this).attr("attr_locationScopeId");
	getStatusSubDivisionWiseWiseCount(statusId,locationScopeId,locationValue,locationScopeId);
	
});
function getStatusSubDivisionWiseWiseCount(statusId,locationScopeId,locationValue,locationScopeId){
	...
	$.ajax({
		...
		if(result !=null && result.length>0){
			buildStatusSubDivisionWiseDetails(result,statusId,locationValue,locationScopeId);
		}else{
			$("#subDivisionBlock"+locationValue).html("No Data Available");
		}
	});
}
function buildStatusSubDivisionWiseDetails(result,statusId,locationValue,locationScopeId){
	getStatusDistrictDayWiseDocuments(statusId,result[0].districtId,result[0].documentId);
	var str='';
	if(locationScopeId == 0){
		str+='<div class="row">';
...
$(document).on("click",".mandalPopups",function(){
	...
	var locationValue = $(this).attr("attr_locationLevelId");
	var locationScopeId = $(this).attr("attr_locationScopeId");
	getStatusMandalWiseWiseCount(statusId,locationScopeId,locationValue);
	
});
function getStatusMandalWiseWiseCount(statusId,locationScopeId,locationValue){
	...
	$.ajax({
		...
		if(result !=null && result.length>0){
			buildStatusMandalWiseDetails(result,statusId,locationValue,locationScopeId);
		}else{
			$("#mandalBlock"+locationValue).html("No Data Available");
		}
	});
}
function buildStatusMandalWiseDetails(result,statusId,locationValue,locationScopeId){
...
$(document).on("click",".workZonePopups",function(){
	...
	var locationValue = $(this).attr("attr_locationLevelId");
	var locationScopeId = $(this).attr("attr_locationScopeId");
	getStatusWorkZoneWiseWiseCount(statusId,locationScopeId,locationValue);
	
});

function getStatusWorkZoneWiseWiseCount(statusId,locationScopeId,locationValue){
...
function getStatusDistrictDayWiseDocuments(statusId,locationScopeId,locationValue){
	...
	$.ajax({
		type:'POST', 
		url: 'getStatusDistrictDayWiseDocumentsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getLocationRelatedWorkDocuments(locationValue){
	...
	$.ajax({
		type:'POST', 
		url: 'getLocationRelatedWorkDocumentsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getMainWorksTimeLineWiseInfo(workTypeId,locationValue){
	var locationScopeId = $("#locationWiseLevelId").val();
	...
	$.ajax({                
		type:'POST',    
		url: 'getMainWorksTimeLineWiseInfoNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
...
function getMainWorkOverViewDetails(mainWorkId){
	...
	$.ajax({                
		type:'POST',    
		url: 'getMainWorkOverViewDetailsNew',
		dataType: 'json',
		data : JSON.stringify(json),
		beforeSend :   function(xhr){
			xhr.setRequestHeader("Accept", "application/json");
