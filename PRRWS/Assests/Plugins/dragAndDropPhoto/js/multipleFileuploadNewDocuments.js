function initializeMultipleUploadNewDocument(id) {
	var itemStr = '';
	...
	$('#'+id).filer({      
    changeInput: '<div class="jFiler-input-dragDrop" style="margin:0px;padding:5px;border:1px solid #ddd;padding-left: 5px;"><a class=""><span style="background-color: #E6E8E5;color: #8A8B8A;padding: 4px;border: 1px solid #d3d3d3;font-size: 12px;border-radius: 3px;cursor: pointer;">Choose file</span> <span style="color: #8A8B8A;font-size: 11px;cursor: pointer;">No file chosen</span></a></div></div>',
    showThumbs: true,
    theme: "dragdropbox",
    ...
    templates: {  
        ...
        captions: {
            ...
            errors: {
                ...
                filesType: " Only PDF are allowed ",
