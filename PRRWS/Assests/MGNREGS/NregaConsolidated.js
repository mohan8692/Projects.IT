 			...
 			tableView+='<tbody>';
				for(var i in result)
				{
					...
					tableView+='<tr>';
						...
						for(var j in result[i].subList)
						{
							if(result[i].subList[j].percentage != null)
							{
								if(result[i].subList[j].component == 'Agriculture Activities')
								{
									...
									{
										tableView+='<td class="" style="background-color:#FF0000;color: white;font-weight: bold;">'+result[i].subList[j].percentage+'</td>';
										redColor = redColor + 1;
									}else if(result[i].subList[j].percentage >= 60)
									{
										tableView+='<td class="" style="background-color:#00AF50;color: white;font-weight: bold;">'+result[i].subList[j].percentage+'</td>';
										GreenColor = GreenColor + 1;
									}
								}else{
									
									if(result[i].subList[j].percentage >= 100){
										tableView+='<td class="" style="background-color:#f7b519;color: white;font-weight: bold;">'+result[i].subList[j].percentage+'</td>';
										...
										tableView+='<td class="" style="background-color:#ff6600;color: white;font-weight: bold;">'+result[i].subList[j].percentage+'</td>';
						...
						tableView+='<td class="" style="background-color:#f7b519;color: white;font-weight: bold;">'+GoldColor+'</td><td class="" style="background-color:#00AF50;color: white;font-weight: bold;">'+GreenColor+'</td><td class="" style="background-color:#ff6600;color: white;font-weight: bold;">'+OrangeColor+'</td><td class="" style="background-color:#FF0000;color: white;font-weight: bold;">'+redColor+'</td>';
					tableView+='</tr>';
				}
			tableView+='</tbody>';
		tableView+='</table>';
