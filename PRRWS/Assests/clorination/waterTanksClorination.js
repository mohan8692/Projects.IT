				...
				str+='<div class="block_styles" style="background-color:#fff;cursor:pointer;">';
					str+='<h3>'+type+' <span class="pull-right tooltipCls" style="margin-top: 10px; font-size: 14px;" data-toggle="tooltip" data-placement="top" title="Service Points">( SP - '+result.noOfSPs+' )</span> </h3>';
						...
						str+='<div class="col-sm-4 border-right">';
							...
							if(result.checked !=null && result.checked>0){
								str+='<h4 class="m_top10 font_weight font_16">'+result.checked+'</h4>';
							}else{
								str+='<h4 class="m_top10 font_weight font_16">0</h4>';
							}
						str+='</div>';
						str+='<div class="col-sm-4 border-right">';
							str+='<h5 class="font_weight">Chlorinated</h5>';
							if(result.clorinated !=null && result.clorinated>0){
								str+='<h4  class="m_top10 font_weight font_16">'+result.clorinated+' <small style="color:red;">'+clorinatedMainPerc+' %</small></h4>';
							}else{
								str+='<h4  class="m_top10 font_weight font_16">0</h4>';
							}
						str+='</div>';
						str+='<div class="col-sm-4">';
							...
							if(result.notClorinated !=null && result.notClorinated>0){
								str+='<h4 class="m_top10 font_weight font_16">'+result.notClorinated+' <small style="color:red;">'+notClorinatedMainPerc+' %</small></h4>';
							}else{
								str+='<h4 class="m_top10 font_weight font_16">0</h4>';
							}
						str+='</div>';
			...
			buttons: [
				{
					...
					titleAttr: 'CSV',
					title:	   "WTC_"+divId,
					filename:  "WTC_"+divId+""+moment().format("DD/MMMM/YYYY  HH:MM"),
				}
			]
