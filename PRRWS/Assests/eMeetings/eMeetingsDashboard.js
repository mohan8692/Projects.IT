...
$(document).on("click",".getDetailsCls",function(){
	...
	var location_type = $("#districtId").attr("attr_location_type");
	console.log($("#districtId option:selected").text());
	name = $("#districtId option:selected").text();
			...
			str+='<div class="table-responsive">';
				str+='<table class="table table-bordered table_Cond" id="dataTabledConductedM">';
					str+='<thead>';
						...
						str+='<th>Panchayat members</th>';
						str+='<th>Attended members</th>';
						str+='<th>Absent members</th>';
						str+='<th>MOM</th>';
						str+='</tr>';
					str+='</thead>';
					str+='<tbody>';
